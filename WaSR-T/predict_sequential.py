...
def predict_sequence(predictor, sequence_dir, output_dir, transform=None):
    ...
    dataset = FolderDataset(sequence_dir, transform=transform, normalize_t=PytorchHubNormalization())
...
def run_inference(args):
    ...
    predict_sequence(predictor, args.sequence_dir, output_dir, transform)
