...
def get_arguments(input_args=None):
    ...
    parser.add_argument("--train_config", type=str, help="Path to the training dataset configuration.")
    parser.add_argument("--val_config", type=str, help="Path to the validation dataset configuration.")
